...
$resultado = mysql_query("SELECT * FROM producto WHERE descrip LIKE '%$buscar%' OR tipo LIKE '%$buscar%' OR cod_ref LIKE '%$buscar%'");
		...
		while($row = mysql_fetch_array($resultado)){
					...
					if ($row['cant_total']== ''){
						...
						echo '<tr">
								...
								<td><div align="center"><input type="button" value="Modificar" class="btn btn-primary" onClick="PrepMod(/'.$row['id_prod'].'/)"></div></td>								
							</tr>';
				}
			}else{
