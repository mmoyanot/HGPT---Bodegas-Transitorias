	...
	$suma = ($lotee['cant_actual']+$suma);
					...
					if ($lotee['vencimiento']== '0000-00-00'){
						...
						echo '<tr>
								...
								<td><div align="center"><input type="button" class="btn btn-success" value="Aceptar" onclick="VerenModal(/'.$lotee['id_lote'].'/,'.$codigo.');"></div></td>
							</tr>';
				}
			}else{
				echo '<tr><td colspan="6"><div align="center"><p class="alert alert-info">No se encontraron registros...</p></div></td></tr>';
			}	
