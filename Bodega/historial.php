	...
	<div class="container">
        ...
        <div class="row">
            	...
            	<div class="panel panel-primary">
                    <div class="panel-heading" align="center"><img src="img/logosinfondo.png" width="50px" height="50px"><strong> G1 - Hospital Geriátrico</strong></div>
                        <div class="panel-body" align="center">
                            ...
                            <a href="nuevoitem.php" class="btn img-rounded" title="Nuevo Producto"><img src="img/idea.png" onMouseOver="this.src='img/idea2.png';" onMouseOut="this.src='img/idea.png';" width="100px" height="100px" data-toggle="popover" data-placement="bottom" data-content="Nuevo"></a>
                            <a href="ingreso.php" class="btn img-rounded" title="Ingreso"><img src="img/in.png" onMouseOver="this.src='img/in2.png';" onMouseOut="this.src='img/in.png';" width="100px" height="100px" data-toggle="popover" data-placement="bottom" data-content="Ingresos"></a>
            ...
            <div class="modal-header">
             	<h4 class="modal-title" id="myModalLabel" align="center"><b>Listado de Item</b></h4>
            </div>
            <div class="modal-body">
            <div align="center" id="tablalistado">
			...
			<tbody>
                ...
                <div id="datosAqui" align="center"></div>
