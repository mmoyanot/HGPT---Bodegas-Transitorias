                ...
                <br>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel" align="center"><b>Modificar datos de un Item</b></h4>
                        </div>
                                ...
                                <fieldset><legend>1. Buscar Item</legend>
                                    <table class="tbl-registro" width="40%">
                                        <tr>
                                            ...
                                            <td width="56%"><input type="text" class="form-control" id="BusquedaItemMod" autofocus style='text-transform:uppercase;'/></td>
                                        </tr>
                                    </table>
                                </fieldset>

                             <div id="mensaje" align="center"></div>
                             <div id="modificar" align="center"></div>
