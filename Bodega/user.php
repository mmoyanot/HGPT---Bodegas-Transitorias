                 ...
                 <fieldset><legend>Datos del Usuario</legend>
                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        <tr>
                            ...
                            <td width="67%"><strong><em><?php echo $_SESSION["nombre"];?> <?php echo $_SESSION["apellido"];?></em></strong></td>
                      	</tr>
                        <tr>
                            <td><strong>Log:</strong></td>
                            <td><strong><em><?php echo $_SESSION["user"];?></em></strong></td>
                       	</tr>
                       	<tr>
                            <td><strong>Correo:</strong></td>
                            <td><strong><em><?php echo $_SESSION["correo"];?></em></strong></td>
                      	</tr>
                        <tr>
                            <td colspan="2"><div align="center"><button class="btn btn-info" type="button" data-toggle="collapse" data-target="#CambioClave" aria-expanded="false" aria-controls="collapseExample">
  					Cambiar Clave
					</button></div></td>
                        </tr>
                    </table>
                    <div class="collapse" id="CambioClave">
                         <table class="table table-bordered table-condensed table-hover">
                            ...
                            <td><input type="password" class="form-control" id="Pass1"/></td>
                            <td><div id="ComproPass1"></div></td>
                        </tr>
                        <tr>
                        	<td><strong>Nueva:</strong></td>
                            <td><input type="password" class="form-control" id="Pass2" disabled="disabled"/></td>
                            <td><div id="ComproPass2"></div></td>
                      	</tr>
                        <tr>
                        	<td><strong>Repita:</strong></td>
                            <td><input type="password" class="form-control" id="Pass3" disabled="disabled"/></td>
                            <td><div id="ComproPass3"></div></td>
                        </tr>
                        <tr>
                        <td colspan="3"><div id="PassOK" align="center"></div></td>
                        </tr>
                        <tr>
                        	<td><input type="button" id="CambioPass" class="btn btn-success" value="Aceptar" disabled="disabled"/></td>
                            <td><input type="button" id="CerrarPass" class="btn btn-danger" value="Cancelar"/></td>
                            <td></td>
                        </tr>
                        </table>
                    </div>
