	...
	<div class="container">
        ...
        <div class="row">
			...
			<tbody>
                ...
                <div id="botonregreso" align="center"></div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Rebaja de Lote</b></h4>
            </div>
            <div class="modal-body" id="datosModalSalida"></div>
          </div>
       </div>
   </div>
