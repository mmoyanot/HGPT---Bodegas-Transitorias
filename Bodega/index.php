	...
	<div class="container">
        ...
        <div class="row">
            ...
            <div class="modal-header">
             	<h4 class="modal-title" id="myModalLabel" align="center"><b>Resumen</b></h4>
            </div>
            <div class="modal-body" align="center">
            <table width="60%">
            <tr>
            <td>
                <table class="table table-bordered table-condensed table-hover" width="351%">
                <thead>
                    <tr>
                        <th width="77%"><div align="center">Descripción</div></th>
                        <th width="23%"><div align="center">Cantidad</div></th>
                    </tr>
                </thead>

                <tbody>
                   <?php $clase->conexion();
                         $clase->ResumenPorVencer();?>
                   <?php $clase->conexion();
                         $clase->ResumenVencidas();?>
                </tbody>
                </table>
            </td>
            </tr>
