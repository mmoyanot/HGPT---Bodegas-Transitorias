	...
	<div class="container">
        ...
        <div class="row">
            ...
            <div class="modal-header">
             	<h4 class="modal-title" id="myModalLabel" align="center"><b>Registro de Nuevo Item</b></h4>
            </div>
            <div class="modal-body">
            	<fieldset><legend>1. Crear Item</legend>
					<table class="tbl-registro" width="100%">
                		<tr>
                    		<td width="18%"><strong>Nombre: </strong></td>
                            <td width="32%"><input type="text" class="form-control" id="Descrip" autofocus style='text-transform:uppercase;'/></td>
                            <td width="17%"><strong>Tipo: </strong></td>
                            <td width="33%"><select class="form-control" id="Tipo">
                            	  <option value="" selected="selected"><b>--SELECCIONE UN TIPO--</b></option>
                                  <option value="ABARROTES">ABARROTES</option>
                                  <option value="ASEO">ASEO</option>
                                  <option value="ESCRITORIO">ESCRITORIO</option>
                                  <option value="OTROS">MENAJE</option>
                                  <option value="OTROS">OTROS</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td><strong>Codigo Ref: </strong></td>
                            <td><input type="text" class="form-control" id="CodRef" style='text-transform:uppercase;'/></td>
                            <td><strong>Creación: </strong></td>
                            <td><input type="text" class="form-control" value="<?php echo date('d-m-Y');?>" id="FechaItem" disabled="disabled"/></td>
                        </tr>
                        <tr>
                            <td colspan="4"><input type="button" id="CrearItem" class="btn btn-success" value="Ingresar Item" /></td>
                        </tr>
                    </table>
                </fieldset>
                    ...
                    <table class="tbl-registro" width="100%">
                        ...
                        <tr>
                         	...
                         	<td colspan="2"><div align="left"><input type="button" id="agregarlote" class="btn btn-success" value="Guardar" disabled="disabled"/></div></td>
                        </tr>
                    </table>
                </fieldset>
                <br />
                ...
                <div class="modal-footer">
                	<strong>Desea ingresar un Nuevo Item?</strong> <input type="button" id="Nuevo" class="btn btn-success" value="Si" disabled="disabled"/>
                </div>
